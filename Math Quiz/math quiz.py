...
def check_solution(user_solution, solution, count):
    if user_solution == solution:
        ...
        print("Incorrect.")
        print("correct answer is : ",abs(solution))
        return count


def menu_option(index, count):
    number_one = random.randrange(1000,99999)
    number_two = random.randrange(1000,99999)
    ...
    if index is 1:
        ...
        problem = str(number_one) + " * " + str( number_three)
        solution = number_one *  number_three
        user_solution = get_user_solution(problem)
        count = check_solution(user_solution, solution, count)
        return count
    else:
